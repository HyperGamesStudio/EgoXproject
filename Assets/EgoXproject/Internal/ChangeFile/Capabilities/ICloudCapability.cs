...
namespace Egomotion.EgoXproject.Internal
{
    internal class ICloudCapability : BaseCapability
    {
        ...
        const string UBIQUITY_KVSTORE_KEY = "com.apple.developer.ubiquity-kvstore-identifier";
        ...
        : base (other)
        {
            ...
            UbiquityKvstoreIdentifier = other.UbiquityKvstoreIdentifier;
        ...
        public string UbiquityKvstoreIdentifier {
            get;
            set;
