...
namespace Egomotion.EgoXproject.Internal
{
    internal class XcodeConfigurations
    {
        ...
        PlatformConfiguration _macosConfigs = new PlatformConfiguration();
        ...
        public bool IsDirty
        {
            get
            {
                return _iosConfigs.IsDirty || _tvosConfigs.IsDirty || _macosConfigs.IsDirty;
            }
            set
            {
                _iosConfigs.IsDirty = value;
                _tvosConfigs.IsDirty = value;
                _macosConfigs.IsDirty = value;
            }
        }
        ...
        public void Save()
        {
            ...
            plist.Root.Add(BuildPlatform.MacOS.ToString(), _macosConfigs.Serialize());
        ...
        void ParseFile(PList plist)
        {
            ...
            _macosConfigs = new PlatformConfiguration(plist.Root.DictionaryValue(BuildPlatform.MacOS.ToString()));
            IsDirty = false;
        }
    }
}
