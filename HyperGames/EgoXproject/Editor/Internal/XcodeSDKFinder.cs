...
namespace Egomotion.EgoXproject.Internal
{
    internal class XcodeSDKFinder
    {
        ...
        public const string DEFAULT_MACOS_SDK_SUBPATH = "Contents/Developer/Platforms/MacOSX.platform/Developer/SDKs";
        ...
        const string DEFAULT_MACOS_SDK_NAME = "MacOSX.sdk";
        ...
        public XcodeSDKFinder(BuildPlatform platform)
        {
            ...
            case BuildPlatform.MacOS:
                string macosSdkPath = Path.Combine (XcodeFinder.XcodeLocation, DEFAULT_MACOS_SDK_SUBPATH);
                IsFound = FindSDK (macosSdkPath, DEFAULT_MACOS_SDK_NAME);
                break;
            }
