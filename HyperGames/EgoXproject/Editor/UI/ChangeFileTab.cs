...
namespace Egomotion.EgoXproject.UI
{
    internal class ChangeFileTab : BaseChangeFileDrawer
    {
        ...
        PListElementDrawerMutable _entitlementsDrawer;
        ...
        : base(parent, style)
        {
            ...
            _entitlementsDrawer = new PListElementDrawerMutable(style);
        }
        ...
        void DrawLanugagueCheckBox(string label, string id) {
            ...
            EditorGUI.BeginChangeCheck();
            bool useConfig = EditorGUILayout.Toggle(label, ChangeFile.AppConfigEnabled.Contains(_plistString), GUILayout.ExpandWidth(false), GUILayout.ExpandHeight(true));
        ...
        void DrawManualEntitlementsSection()
        {
            ...
            EditorGUI.indentLevel++;
            string description = "Add or replace entries in the "+Application.productName+".entitlements file.\n" +
                                 "- Existing values will be replaced.\n" +
                                 "- Dictionaries will have entries added or replaced if they exist.\n" +
                                 "- Arrays will have entries appended unless they match exactly.";
            EditorGUILayout.LabelField(description, EditorStyles.wordWrappedLabel);
            ...
            if (_entitlementsDrawer.IsDirty)
            {
                ChangeFile.IsDirty = true;
            }
        ...
        void DrawAppSandboxCapability(AppSandboxCapability capability)
        {
            ...
            EditorGUILayout.EndVertical();
            EditorGUILayout.BeginVertical();
            capability.KeyNetworkServer = EditorGUILayout.ToggleLeft("Incoming Connection (Server)", capability.KeyNetworkServer);
            capability.KeyNetworkClient = EditorGUILayout.ToggleLeft("Outgoing Connection (Client)", capability.KeyNetworkClient);
            GUILayout.Space(10);
            EditorGUILayout.EndVertical();
            ...
            EditorGUILayout.EndVertical();
            EditorGUILayout.BeginVertical();
            capability.KeyCamera = EditorGUILayout.ToggleLeft("Camera", capability.KeyCamera);
            capability.KeyAudio = EditorGUILayout.ToggleLeft("Audio Input", capability.KeyAudio);
            capability.KeyUSB = EditorGUILayout.ToggleLeft("USB", capability.KeyUSB);
            capability.KeyPrinting = EditorGUILayout.ToggleLeft("Printing", capability.KeyPrinting);
            capability.KeyBluetooth = EditorGUILayout.ToggleLeft("Bluetooth", capability.KeyBluetooth);
            GUILayout.Space(10);
            EditorGUILayout.EndVertical();
            ...
            EditorGUILayout.EndVertical();
            EditorGUILayout.BeginVertical();
            capability.KeyContacts = EditorGUILayout.ToggleLeft("Contacts", capability.KeyContacts);
            capability.KeyLocation = EditorGUILayout.ToggleLeft("Location", capability.KeyLocation);
            capability.KeyCalendar = EditorGUILayout.ToggleLeft("Calendar", capability.KeyCalendar);
            GUILayout.Space(10);
            EditorGUILayout.EndVertical();
            ...
            EditorGUILayout.BeginVertical(GUILayout.Width(CAPABILITY_FIRST_COLUMN_WIDTH), GUILayout.ExpandWidth(false));
            EditorGUILayout.LabelField("File Access:", GUILayout.Width(CAPABILITY_FIRST_COLUMN_WIDTH), GUILayout.ExpandWidth(false));
            EditorGUILayout.EndVertical();
            EditorGUILayout.BeginVertical();
            capability.KeyUserSelectedFiles = (AppSandboxCapability.READ_WRITE_OPTIONS)EditorGUILayout.EnumPopup("User Selected Files", capability.KeyUserSelectedFiles);
            capability.KeyDownloadsFolder = (AppSandboxCapability.READ_WRITE_OPTIONS)EditorGUILayout.EnumPopup("Downloads Folder", capability.KeyDownloadsFolder);
            capability.KeyPicturesFolder = (AppSandboxCapability.READ_WRITE_OPTIONS)EditorGUILayout.EnumPopup("Pictures Folder", capability.KeyPicturesFolder);
            capability.KeyMusicFolder = (AppSandboxCapability.READ_WRITE_OPTIONS)EditorGUILayout.EnumPopup("Music Folder", capability.KeyMusicFolder);
            capability.KeyMoviesFolder = (AppSandboxCapability.READ_WRITE_OPTIONS)EditorGUILayout.EnumPopup("Movies Folder", capability.KeyMoviesFolder);
        ...
        public void Save()
        {
            if (ChangeFile != null)
            {
                ...
                _entitlementsDrawer.IsDirty = false;
            }
        }
