...
namespace Egomotion.EgoXproject.UI
{
    internal class PreviewTab : BaseChangeFileDrawer
    {
        ...
        void LoadMergedFile()
        {
            ...
            SetFoldout(Sections.AppConfig, ChangeFile.AppConfig.Count > 0);
        ...
        void DrawAppConfigSection()
        {
            if (!DrawFoldOut(Sections.AppConfig))
            {
                return;
            }
        }
        ...
        void DrawCapability(SystemCapability systemCapability, BaseCapability capability)
        {
            ...
            case SystemCapability.AppSandbox:
                DrawAppSandboxCapability(capability as AppSandboxCapability);
                break;
            ...
            case SystemCapability.AppleArcade:
                DrawAppleArcadeCapability(capability as AppleArcadeCapability);
                break;            
        ...
        void DrawICloudCapability(ICloudCapability capability)
        {
            ...
            if (!string.IsNullOrEmpty(capability.UbiquityKvstoreIdentifier))
            {
                EditorGUILayout.LabelField("Ubiquity KVStore Identifier: "+capability.UbiquityKvstoreIdentifier);
            }
 ...
 //iCloud
        void DrawAppSandboxCapability(AppSandboxCapability capability)
        {
            
            EditorGUILayout.BeginHorizontal();
            EditorGUILayout.BeginVertical(GUILayout.Width(CAPABILITY_FIRST_COLUMN_WIDTH), GUILayout.ExpandWidth(false));
            EditorGUILayout.LabelField("Network:", GUILayout.Width(CAPABILITY_FIRST_COLUMN_WIDTH), GUILayout.ExpandWidth(false));
            EditorGUILayout.EndVertical();
            EditorGUILayout.BeginVertical();
            if (capability.KeyNetworkServer) EditorGUILayout.LabelField("Incoming Connections (Server)");
            if (capability.KeyNetworkClient) EditorGUILayout.LabelField("Outgoing Connections (Client)");
            GUILayout.Space(5);
            EditorGUILayout.EndVertical();
            EditorGUILayout.EndHorizontal();
            ...
            EditorGUILayout.BeginHorizontal();
            EditorGUILayout.BeginVertical(GUILayout.Width(CAPABILITY_FIRST_COLUMN_WIDTH), GUILayout.ExpandWidth(false));
            EditorGUILayout.LabelField("Hardware:", GUILayout.Width(CAPABILITY_FIRST_COLUMN_WIDTH), GUILayout.ExpandWidth(false));
            EditorGUILayout.EndVertical();
            EditorGUILayout.BeginVertical();
            if (capability.KeyCamera) EditorGUILayout.LabelField("Camera");
            if (capability.KeyAudio) EditorGUILayout.LabelField("Audio");
            if (capability.KeyUSB) EditorGUILayout.LabelField("USB");
            if (capability.KeyPrinting) EditorGUILayout.LabelField("Printing");
            if (capability.KeyBluetooth) EditorGUILayout.LabelField("Bluetooth");
            GUILayout.Space(5);
            EditorGUILayout.EndVertical();
            EditorGUILayout.EndHorizontal();
            ...
            EditorGUILayout.BeginHorizontal();
            EditorGUILayout.BeginVertical(GUILayout.Width(CAPABILITY_FIRST_COLUMN_WIDTH), GUILayout.ExpandWidth(false));
            EditorGUILayout.LabelField("App Data:", GUILayout.Width(CAPABILITY_FIRST_COLUMN_WIDTH), GUILayout.ExpandWidth(false));
            EditorGUILayout.EndVertical();
            EditorGUILayout.BeginVertical();
            if (capability.KeyContacts) EditorGUILayout.LabelField("Contacts");
            if (capability.KeyLocation) EditorGUILayout.LabelField("Location");
            if (capability.KeyCalendar) EditorGUILayout.LabelField("Calendar");
            GUILayout.Space(5);
            EditorGUILayout.EndVertical();
            EditorGUILayout.EndHorizontal();
            ...
            EditorGUILayout.EndVertical();
            EditorGUILayout.BeginVertical();
            if (capability.KeyUserSelectedFiles == AppSandboxCapability.READ_WRITE_OPTIONS.ReadOnly) EditorGUILayout.LabelField("User Selected File: Read Only");
            else if (capability.KeyUserSelectedFiles == AppSandboxCapability.READ_WRITE_OPTIONS.ReadWrite) EditorGUILayout.LabelField("User Selected File: Read/Write");
            
            if (capability.KeyDownloadsFolder == AppSandboxCapability.READ_WRITE_OPTIONS.ReadOnly) EditorGUILayout.LabelField("Downloads Folder: Read Only");
            else if (capability.KeyDownloadsFolder == AppSandboxCapability.READ_WRITE_OPTIONS.ReadWrite) EditorGUILayout.LabelField("Downloads Folder: Read/Write");
            
            if (capability.KeyPicturesFolder == AppSandboxCapability.READ_WRITE_OPTIONS.ReadOnly) EditorGUILayout.LabelField("Pictures Folder: Read Only");
            else if (capability.KeyPicturesFolder == AppSandboxCapability.READ_WRITE_OPTIONS.ReadWrite) EditorGUILayout.LabelField("Pictures Folder: Read/Write");
            
            if (capability.KeyMusicFolder == AppSandboxCapability.READ_WRITE_OPTIONS.ReadOnly) EditorGUILayout.LabelField("Music Folder: Read Only");
            else if (capability.KeyMusicFolder == AppSandboxCapability.READ_WRITE_OPTIONS.ReadWrite) EditorGUILayout.LabelField("Music Folder: Read/Write");
            
            if (capability.KeyMoviesFolder == AppSandboxCapability.READ_WRITE_OPTIONS.ReadOnly) EditorGUILayout.LabelField("Movies Folder: Read Only");
            else if (capability.KeyMoviesFolder == AppSandboxCapability.READ_WRITE_OPTIONS.ReadWrite) EditorGUILayout.LabelField("Movies Folder: Read/Write");
            GUILayout.Space(5);
            EditorGUILayout.EndVertical();
            EditorGUILayout.EndHorizontal();
        ...
        //Apple Arcade
        void DrawAppleArcadeCapability(AppleArcadeCapability capability)
        {
            //No additional user options required
        }        
